...
java Riemann riemanntest                                                            >> testresults.txt
...
echo ============================================================================   >> testresults.txt
REM @java Riemann poly 0 1 2                                                            >> testresults.txt
...
echo ============================================================================   >> testresults.txt
REM @java Riemann sin -0.27 +3.55                                                       >> testresults.txt
...
echo ============================================================================   >> testresults.txt
REM @java Riemann sin -17.0 3.0 -11.0 11.0 1e-7%%                                       >> testresults.txt
...
echo ============================================================================   >> testresults.txt
REM @java Riemann sin -17.0 1.0 -23.0 23.0 1e-4%%                                       >> testresults.txt
