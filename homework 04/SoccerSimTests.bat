...
echo ...   Or should output a message of some type >> testresults.txt
echo ======================================  >> testresults.txt
Rem @java SoccerSim 10 10  5  5 0.0              >> testresults.txt
...
echo ======================================  >> testresults.txt
REM @java SoccerSim 200 200 10 10 100 100 -100 -100 150 150 200 200 175 175 -110 -110 20 20 1 1 50 50 -5 -5 0.1 >> testresults.txt
@java SoccerSim 20 20 10 10 100 100 -100 -100 110 110 200 200 75 75 -110 -110 20 20 1 1 50 50 -5 -5 0.1 >> testresults.txt
...
echo ======================================  >> testresults.txt
REM @java SoccerSim 200 200 10 10 100 100 -100 -100 150 150 200 200 175 175 -110 -110 20 20 1 1 50 50 -5 -5 1.234  >> testresults.txt
@java SoccerSim 20 20 10 10 100 100 -100 -100 110 110 200 200 75 75 -110 -110 20 20 1 1 50 50 -5 -5 1.234 >> testresults.txt
...
echo ======================================  >> testresults.txt
REM @java SoccerSim 150 150 10 10 100 100 -100 -100 200 200 200 200 250 250 -110 -110 20 20 1 1 50 50 -5 -5 -100 -100 200 200 -200 -200 300 300 -110 -110 20 20 1 1 50 50 10.0 >> testresults.txt
@java SoccerSim 150 100 10 10 100 100 -100 -100 20 20 200 200 50 50 -110 -110 27 27 1 1 53 53 -5 -5 -100 -100 200 200 -20 -20 300 300 -110 -110 20 20 1 1 50 50 10.0 >> testresults.txt
